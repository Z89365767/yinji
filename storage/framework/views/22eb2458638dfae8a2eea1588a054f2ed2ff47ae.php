<?php $__env->startSection('title'); ?>
    <?php echo e(trans('designer.all_designer')); ?>_<?php echo e(trans('comm.yinji')); ?>
...
<section class="wrapper box" style="min-height: 670px">
    <div class="nav_fenlei">
        ...
        <ul class="categories-wrap" data-categories = '<?php echo e($categories); ?>'>

            <li <?php if(!isset($current_category) || $current_category == 0): ?> class="current-cat" <?php endif; ?>><a href="/designer" ><?php echo e(trans('designer.all')); ?></a></li>

            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <li style="display:<?php echo e($key>7?'none':'block'); ?>" <?php if(isset($current_category) && $current_category == $category->id): ?> class="current-cat" <?php endif; ?>><a href="/designer/category/<?php echo e($category->id); ?>"><?php if('zh-CN' == $lang): ?> <?php echo e($category->name_cn); ?> <?php else: ?> <?php echo e($category->name_en); ?> <?php endif; ?></a></li>
        ...
        <ul class="layout_ul ajaxposts designer-content">
            ...
            <li class="layout_li ajaxpost ">
                ...
                <article class="postgrid design" style="visibility: visible; animation-name: bounceInUp;">
                    ...
                    <figure> <a href="<?php if($designer->static_url): ?> /designer/<?php echo e($designer->static_url); ?> <?php else: ?> /designer/detail/<?php echo e($designer->id); ?> <?php endif; ?>" title="<?php echo e(get_designer_title($designer)); ?>" target="_blank">

                            <img class="thumb" src="<?php echo e(get_designer_thum($designer)); ?>" data-original="<?php echo e(get_designer_thum($designer)); ?>" alt="<?php echo e(get_designer_title($designer)); ?>" style="display: block;"> </a> </figure>

                    <section class="ffe_main">

                        <h2><a href="<?php if($designer->static_url): ?> /designer/<?php echo e($designer->static_url); ?> <?php else: ?> /designer/detail/<?php echo e($designer->id); ?> <?php endif; ?>" title="<?php echo e(get_designer_title($designer)); ?>" target="_blank"><?php echo e(get_designer_title($designer)); ?></a></h2>
