...
<title><?php echo e(trans('comm.yinji')); ?> — <?php echo e(trans('login.login')); ?></title>
...
<div id="login"> 
  ...
  <div style=" overflow:hidden">
    ...
    <p id="nav" class="nav fr"> <a href="/user/register"><?php echo e(trans('login.register')); ?></a> | <a



                    href="/user/forgot_password"><?php echo e(trans('login.forgot_password')); ?></a> </p>

    <p class="fl backtoblog"> <a href="/"> ← <?php echo e(trans('login.return')); ?> </a> </p>

  </div>

  <div class=""> <span style="float:left; line-height:36px;color: #999;"> <?php echo e(trans('login.other_login')); ?>：</span>
