...
use App\Models\DesignerComment as CurrentModel;

class DesignerCommentController extends BaseController
{
    use HasResourceActions;
    
    public $strHeader    = '设计师评论';
    ...
    protected function grid()
    {
        ...
        $grid->id('ID')->sortable();
        $grid->comment_id('设计师ID')->sortable();
        $grid->comment_title('设计师')->sortable()->display(function () {
            $obj = Designer::find($this->comment_id);
            if ($obj) {
