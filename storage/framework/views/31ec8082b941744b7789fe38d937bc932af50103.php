      ...
      <div class="modal-dialog">
          ...
          <div class="modal-body">
              ...
              <ul class="discover-folders2">
                        <?php $__currentLoopData = $user_collect_folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                  <h3><?php echo e($value); ?></h3>
                  <span img="" floder_id="<?php echo e($key); ?>" class="folderattr null" title="<?php echo e($value); ?>"></span> <a href=" " class="Button2 fr collect_article" data-id="<?php echo e($key); ?>">收藏</a > </li>
      ...
      <p><?php echo e(get_article_title($new_article[0])); ?></p>
            ...
            <div id="qq">
                <div class="qq_liuyan">
                    <a name="df"></a>
                    <h2 class="left">评语</h2>
                    <span class=" right">共<span class=" c_red"><?php echo e(isset($comments_total) ? $comments_total : '0'); ?></span>条评语</span> 
                </div>
                <div class="msgCon"> 
                    ...
                    <?php if($comment->content): ?>
                        ...
                        <?php endif; ?>
                        <span>发布于：<?php echo e($comment->created_at); ?></span></dd>
                        <ul class="show_number clearfix">
					       <li>
                        ...
                        <div class="msgTxt">评语： <?php echo $comment->content; ?></div>
  ...
  <div class="sidebar right cat4_sidebar" style="margin-top:-220px;    position: absolute;
    ...
    margin-right: -600px;">
      ...
      <div class="item author-info" style=" padding:0">
                <div class="users"> <?php if($designer): ?>
          ...
          <?php if($is_subscription): ?> <span class="Button wpfp_designer_act designer have-disalbed " title=""> 已订阅 </span> <?php else: ?> <span class="Button3 wpfp_designer_act designer subscription_designer" designer_id="<?php echo e($designer->id); ?>" title=""> 订阅 </span> <?php endif; ?>
          ...
          <div class="works_design">
              ...
              <li>
                  ...
                  <?php if('1' == $designer->industry): ?>
                  <p>INTERIOR  <?php if(!$designer->is_subscription): ?> <a href="javascript:void(0)" class="subscription_next_designer" designer_id="<?php echo e($designer->id); ?>" class="right">+订阅</a><?php endif; ?></p>
                  <?php else: ?>
                  <p>Architect <?php if(!$designer->is_subscription): ?><a href="javascript:void(0)" class="subscription_next_designer" designer_id="<?php echo e($designer->id); ?>" class="right">+订阅</a><?php endif; ?></p>
                  <?php endif; ?> </div>
                      </li>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
