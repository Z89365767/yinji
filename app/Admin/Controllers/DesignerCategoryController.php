...
use App\Models\DesignerCategory as CurrentModel;

class DesignerCategoryController extends BaseController
{
    use HasResourceActions;
    
    public $strHeader    = '名师分类';
    ...
    protected function grid()
    {
        ...
        $grid->name_en_abbr('名称（英/简）')->sortable();
